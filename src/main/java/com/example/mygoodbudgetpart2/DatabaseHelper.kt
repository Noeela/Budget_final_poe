...
class DatabaseHelper(context: Context) : SQLiteOpenHelper(
    ...
    companion object {
        ...
        // Table for Savings
        private const val TABLE_SAVING = "saving_table"
        private  const val COLUMN_SAVING_ID = "id"
        private const val COLUMN_SAVING_NAME = "name"
        private const val COLUMN_SAVING_AMOUNT = "amount"

        // Table for Rewards
        private const val TABLE_REWARD = "reward_table"
        private  const val COLUMN_REWARD_ID = "id"
        private const val COLUMN_REWARD_NAME = "name"
        private const val COLUMN_REWARD_DESCRIPTION ="description"
        private const val COLUMN_REWARD_STATUS = "status"
